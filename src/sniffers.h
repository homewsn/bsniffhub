...
//--------------------------------------------
#define SNIFFER(name, id, baudrate, flow_control, init, decode, follow, passkey_set, oob_key_set, ltk_set,\
                min_rssi_set, adv_channel_set, mac_addr_set, follow_aux_connect, close) \
	const sniffer_t name = { id, baudrate, flow_control, init, decode, follow, passkey_set, oob_key_set, ltk_set,\
                             min_rssi_set, adv_channel_set, mac_addr_set, follow_aux_connect, close }
